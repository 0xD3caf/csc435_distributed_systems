...
//            ArrayList<DocFreqPair> updatedMap = termInvertedIndex.getOrDefault(word.toLowerCase(),new ArrayList<DocFreqPair>());
//            updatedMap.add(new DocFreqPair(documentNumber, wordFrequencies.get(word.toLowerCase())));
//            termInvertedIndex.put(word.toLowerCase(), updatedMap);
            synchronized (this) {
